...
.directive('statusbartabsize', function() {
    return {
        ...
        template: '<div class="dropdown statusbar-indent-dropdown">' +
                ...
                '           <li ng-repeat="indent in indentNumbers" data-indent="{{indent}}" ng-click="fnChangeIndent($event)"><a href="#"> Tab Width: {{indent}} <i ng-show="indent === tabSize" class="fa fa-check pull-right"></i></a></li>' +
                '   </ul>' +
                '</div>'  
    }
})
